...
export default function Button({ play, details }: { play?: boolean; details?: boolean }) {
    const iconSize = 22;
    ...
    return (
        <>
            {play ? (
                ...
                <Link href={'/Details'} className={"flex items-center justify-center gap-2 bg-mainText/10 font-semibold text-xl rounded-xl text-mainText px-4 h-10 sm:h-11 md:h-12"}>
